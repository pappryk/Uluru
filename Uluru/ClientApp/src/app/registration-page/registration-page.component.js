  ...
  workingGroupName;
    ...
    onClick() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                workingGroupResponse = yield this.http.post(baseUrl + 'api/workingGroup', workingGroup).toPromise();
            }
            catch (err) {
            ...
            let response = this.userService.postUser(baseUrl + 'api/users', user);
